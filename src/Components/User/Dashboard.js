            ...
            <div className="dashboard grid grid-cols-3 gap-4 mt-4">
              <div className="col">
                <div className="bg-yellow-100 rounded p-4">
                  ...
                  <h1 className="text-3xl font-bold text-yellow-500">1000</h1>
                </div>
              </div>
              <div className="col">
                <div className="bg-yellow-100 rounded p-4">
                  <p className="text-xl font-semibold">Processing Parcels</p>
                  <h1 className="text-3xl font-bold text-yellow-500">236</h1>
                </div>
              </div>
              <div className="col">
                <div className="bg-yellow-100 rounded p-4">
                  <p className="text-xl font-semibold">Delivered Parcels</p>
                  <h1 className="text-3xl font-bold text-yellow-500">764</h1>
                </div>
              </div>
            </div>
      ...
      <footer className="bg-yellow-500 text-white py-4">
        <div className="container mx-auto text-center">
          <p className="font-semibold">
            Parcel<span className="text-yellow-500">Pal</span>, Copyright &copy; {new Date().getFullYear()}
          </p>
        </div>
      </footer>
    </div>
